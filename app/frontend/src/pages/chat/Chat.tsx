                    ...
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            ...
                            <span className={styles.chatEmptyObjectives}>
                                <i>Tech Assistant uses AI. Check for mistakes.   </i><a href="https://github.com/ttcu/PubSec-Info-Assistant/blob/main/docs/transparency.md" target="_blank" rel="noopener noreferrer">Transparency Note</a>
                            </span>
